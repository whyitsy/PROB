...
CHECKPOINT="/mnt/data/kky/output/PROB/exps/MOWODB/UOD_CH3_FULL/t4_ft/checkpoint.pth"
DATA_ROOT="/mnt/data/kky/datasets/owdetr/data/OWOD"

DUMP_DIR="/mnt/data/kky/output/PROB/exps/OUTPUTS/MOWODB/ch3_t4_ft"
FIG_DIR="/mnt/data/kky/output/PROB/exps/OUTPUTS/MOWODB/ch3_t4_ft"
