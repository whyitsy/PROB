...
class DeformableDETR(nn.Module):
    ...
    def forward(self, samples: NestedTensor):
        ...
        hs, init_reference, inter_references, enc_outputs_class, enc_outputs_coord_unact = self.transformer(srcs, masks, pos, query_embeds, tdqi=self.args.tdqi, tdqi_query_num=self.args.tdqi_query_num)
        ...
        out = {'pred_logits': outputs_class[-1], 'pred_boxes': outputs_coord[-1], 'pred_obj':outputs_objectness[obj_layer]} 
    ...
    def _set_aux_loss(self, outputs_class, outputs_coord, objectness):
        ...
        aux_loss = [{'pred_logits': a, 'pred_obj': b, 'pred_boxes': c,}
...
class SetCriterion(nn.Module):
    ...
    def loss_labels(self, outputs, targets, indices, num_boxes, log=True, **kwargs):
        ...
        # [新增] 提取伪正样本索引，并在分类损失中屏蔽它们（避免被当做背景惩罚）
