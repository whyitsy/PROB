...
def build_parser():
    parser = argparse.ArgumentParser('SVG batch renderer v2 for mined representative cases', parents=[get_args_parser()])
...
def main(parsed_args):
    ...
    print(f'Saved SVG rendered mined cases v2 to: {out_dir}')
