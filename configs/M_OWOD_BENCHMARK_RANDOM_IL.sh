...
python -u main_open_world.py \
    ...
    --resume "${EXP_DIR}/t1/checkpoint0040.pth" --lr 2e-5\
    --exemplar_replay_random\
    ${PY_ARGS}
...
python -u main_open_world.py \
    ...
    --resume "${EXP_DIR}/t2/checkpoint0050.pth"\
    ${PY_ARGS}
...
python -u main_open_world.py \
    ...
    --resume "${EXP_DIR}/t2_ft/checkpoint0110.pth" --lr 2e-5 \
    --exemplar_replay_random\
    ${PY_ARGS}
...
python -u main_open_world.py \
    ...
    --resume "${EXP_DIR}/t3/checkpoint0120.pth"\
    ${PY_ARGS}
...
python -u main_open_world.py \
    ...
    --resume "${EXP_DIR}/t3_ft/checkpoint0180.pth" --lr 2e-5\
    --exemplar_replay_random\
    ${PY_ARGS}
...
python -u main_open_world.py \
    ...
    --resume "${EXP_DIR}/t4/checkpoint0190.pth" \
    ${PY_ARGS}
