...
OUTPUTS_VIS_DIR="${OUTPUTS_VIS_DIR:-/mnt/data/kky/output/PROB/exps/OUTPUTS/MOWODB/UOD_CH3_FULL_VIS_V2}"
...
run_stage_offline_visualization() {
  ...
  run_python_module tools.mine_representative_cases_svg_v2 \
  ...
  run_python_module tools.render_mined_cases_svg_v2 \
    --checkpoint "${checkpoint_path}" \
