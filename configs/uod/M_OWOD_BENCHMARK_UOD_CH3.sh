...
# 第三章方法（创新点1）的完整四阶段主实验脚本。
# 比baseline, 统一打开了第三章的方法开关：uod_enable_unknown + uod_enable_pseudo + uod_enable_batch_dynamic

echo running chapter-3 UOD training, M-OWODB dataset
set -x

EXP_DIR=/mnt/data/kky/output/PROB/exps/MOWODB/UOD_CH3
TAG=UOD_CH3
PY_ARGS=${@:1}
