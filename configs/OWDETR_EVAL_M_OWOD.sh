...
python -u main_open_world.py \
    ...
    --pretrain "${EXP_DIR}/t1.pth" --eval  --unk_conf_w 4.1 --eval\
    ${PY_ARGS}
...
python -u main_open_world.py \
    ...
    --train_set "owod_t1_train" --test_set 'owod_all_task_test' --epochs 191 --lr_drop 35\
    --model_type 'owdetr' --obj_loss_coef 8e-4 --obj_temp 1.3\
    --pretrain "${EXP_DIR}/t1.pth" --eval  --unk_conf_w 4.2 --eval\
    ${PY_ARGS}
...
python -u main_open_world.py \
    ...
    --train_set "owod_t1_train" --test_set 'owod_all_task_test' --epochs 191 --lr_drop 35\
    --model_type 'owdetr' --obj_loss_coef 8e-4 --obj_temp 1.3\
    --pretrain "${EXP_DIR}/t1.pth" --eval  --unk_conf_w 4.3 --eval\
    ${PY_ARGS}
...
python -u main_open_world.py \
    ...
    --train_set "owod_t1_train" --test_set 'owod_all_task_test' --epochs 191 --lr_drop 35\
    --model_type 'owdetr' --obj_loss_coef 8e-4 --obj_temp 1.3\
    --pretrain "${EXP_DIR}/t1.pth" --eval  --unk_conf_w 4.4 --eval\
    ${PY_ARGS}
