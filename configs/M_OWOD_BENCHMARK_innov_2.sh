...
python -u main_open_world.py \
    ...
    --enable_unk_label_obj --etop --tdqi --model_type 'innov_2'\
    --use_feature_align --use_vlm_distill --lr_drop 35  --batch_size 2 --lr 1e-4
    ${PY_ARGS}
...
#     --obj_temp 1.3 --freeze_prob_model\
...
#     --enable_unk_label_obj --obj_loss_coef 10 --etop --tdqi --model_type 'innov_2' --lr 1e-4
#     ${PY_ARGS}
...
#     --freeze_prob_model --obj_temp 1.3\
...
#     --enable_unk_label_obj --obj_loss_coef 10 --etop --tdqi --model_type 'innov_2' --lr 1e-5
#     ${PY_ARGS}
