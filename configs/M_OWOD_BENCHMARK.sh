...
python -u main_open_world.py \
    ...
    --exemplar_replay_dir PROB_V1 --exemplar_replay_cur_file 'learned_owod_t1_ft.txt' \
    --viz --viz_num_samples 12 --viz_tb_images 4 ${PY_ARGS}
...
python -u main_open_world.py \
    ...
    --exemplar_replay_selection --exemplar_replay_max_length 1743 --exemplar_replay_dir PROB_V1 \
...
python -u main_open_world.py \
    ...
    --train_set 'PROB_V1/learned_owod_t2_ft' --test_set 'owod_all_task_test' --epochs 111 --lr_drop 40 \
    --model_type 'prob' --obj_loss_coef 8e-4 --obj_temp 1.3 \
...
python -u main_open_world.py \
    ...
    --exemplar_replay_selection --exemplar_replay_max_length 2361 --exemplar_replay_dir PROB_V1 \
...
python -u main_open_world.py \
    ...
    --train_set 'PROB_V1/learned_owod_t3_ft' --test_set 'owod_all_task_test' --epochs 181 --lr_drop 35 \
    --model_type 'prob' --obj_loss_coef 8e-4 --obj_temp 1.3 \
...
python -u main_open_world.py \
    ...
    --model_type 'prob' --obj_loss_coef 8e-4 --freeze_prob_model --obj_temp 1.3 \
    --exemplar_replay_selection --exemplar_replay_max_length 2749 --exemplar_replay_dir PROB_V1 \
...
python -u main_open_world.py \
    ...
    --train_set 'PROB_V1/learned_owod_t4_ft' --test_set 'owod_all_task_test' --epochs 261 --lr_drop 50 \
    --model_type 'prob' --obj_loss_coef 8e-4 --obj_temp 1.3 \
