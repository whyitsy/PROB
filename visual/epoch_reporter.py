...
def build_train_epoch_record(epoch, train_stats, num_trainable_parameters):
    ...
    return {
        ...
        'train_weighted_loss_ce': _safe_float(train_stats.get('weighted_loss_ce')),
        'train_raw_loss_ce': _safe_float(train_stats.get('raw_loss_ce')),
        'train_weighted_loss_bbox': _safe_float(train_stats.get('weighted_loss_bbox')),
        'train_raw_loss_bbox': _safe_float(train_stats.get('raw_loss_bbox')),
        'train_weighted_loss_giou': _safe_float(train_stats.get('weighted_loss_giou')),
        'train_raw_loss_giou': _safe_float(train_stats.get('raw_loss_giou')),
        'train_weighted_loss_obj_ll': _safe_float(train_stats.get('weighted_loss_obj_ll')),
        'train_raw_loss_obj_ll': _safe_float(train_stats.get('raw_loss_obj_ll')),
        'train_weighted_loss_unk_known': _safe_float(train_stats.get('weighted_loss_unk_known')),
        'train_raw_loss_unk_known': _safe_float(train_stats.get('raw_loss_unk_known')),
        'train_weighted_loss_obj_pseudo': _safe_float(train_stats.get('weighted_loss_obj_pseudo')),
        'train_raw_loss_obj_pseudo': _safe_float(train_stats.get('raw_loss_obj_pseudo')),
        'train_weighted_loss_obj_neg': _safe_float(train_stats.get('weighted_loss_obj_neg')),
        'train_raw_loss_obj_neg': _safe_float(train_stats.get('raw_loss_obj_neg')),
        'train_weighted_loss_unk_pseudo': _safe_float(train_stats.get('weighted_loss_unk_pseudo')),
        'train_raw_loss_unk_pseudo': _safe_float(train_stats.get('raw_loss_unk_pseudo')),
        'train_weighted_loss_decorr': _safe_float(train_stats.get('weighted_loss_decorr')),
        'train_raw_loss_decorr': _safe_float(train_stats.get('raw_loss_decorr')),
        'train_weighted_loss_bbox_pseudo_cons': _safe_float(train_stats.get('weighted_loss_bbox_pseudo_cons')),
        'train_raw_loss_bbox_pseudo_cons': _safe_float(train_stats.get('raw_loss_bbox_pseudo_cons')),
        'train_weighted_loss_giou_pseudo_cons': _safe_float(train_stats.get('weighted_loss_giou_pseudo_cons')),
        'train_raw_loss_giou_pseudo_cons': _safe_float(train_stats.get('raw_loss_giou_pseudo_cons')),
        ...
        'num_unmatched_queries_after_filter': _safe_float(train_stats.get('num_unmatched_queries_after_filter', train_stats.get('stat_num_valid_unmatched'))),
        ...
        'train_total_knownness_loss': _sum_optional_floats(train_stats.get('raw_loss_unk_known'), train_stats.get('raw_loss_unk_pseudo')),
    }
